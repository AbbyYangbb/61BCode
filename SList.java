...
public class SList {
  ...
  public void twin() {
      SListNode curr = head;
      while (curr != null){
          curr.next = new SListNode(curr.item, curr.next);  // excution order
          curr = curr.next.next;    // equal first OR new first?? (new)
      }
